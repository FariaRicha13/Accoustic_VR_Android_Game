...
public class story2seg10 extends AppCompatActivity {
    private Button b1;
    int maxid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story2seg10);
        b1=findViewById(R.id.b1);
        relativeLayout = findViewById(R.id.relative_lay);
        number = getIntent().getStringExtra("number");
        ref=database.getInstance().getReference("Score").child("L2");
        ref1 = database.getInstance().getReference("Final Score").child("L2").child(number);
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this,R.raw.song_10);
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(textView.getText().toString().equals("next"))
                        {
                            ...
                            fnum= (float) (((sum+2.0)*(1.0-5.0))/((-2.0-6.0))+1.0);
    ...
    private void  openGameOption() {
        ...
        intent.putExtra("number",number); intent.putExtra("Game State", "Story2_seg10");
