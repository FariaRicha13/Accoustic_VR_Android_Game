...
public class Story3l3op1 extends AppCompatActivity {
    private Button b1;
    int maxid;
...
FirebaseDatabase database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story3l3op1);
        b1=findViewById(R.id.b1);
        relativeLayout = findViewById(R.id.relative_lay);
        number = getIntent().getStringExtra("number");
        ref = database.getInstance().getReference("Score").child("L3").child("S3");
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this, R.raw.song_l3s3o1);
...
break;}
    ...
    private void openGameOption() {
        ...
        intent.putExtra("Game State", "Story3l3op1");
        startActivity(intent);
    }

    private void  openStory2_2() {
        Intent intent = new Intent(this,  Story3l3op2.class);
        intent.putExtra("number",number);
        startActivity(intent);
    }
    private void  openStory2_3() {
