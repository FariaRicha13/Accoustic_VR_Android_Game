...
public class Story3seg1out2_next extends AppCompatActivity {
    private Button b1;
    int maxid;
...
FirebaseDatabase database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this, R.raw.song_l3s3);
...
break;}
    ...
    private void openGameOption() {
        ...
        intent.putExtra("Game State", "Story3_seg1_out2_next");
