...
public class Story3seg1_Out1 extends AppCompatActivity {
    private Button b1;
    int maxid;
    ...
    MediaPlayer player,player1,player2,player3,player4,player5,player6,player7,player8,player9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this, R.raw.song_l3s2o1);
    ...
    private void openGameOption() {
        ...
        intent.putExtra("Game State", "Story3_seg1_out1");
