...
public class story2seg8 extends AppCompatActivity {
    private Button b1;
    int maxid;
   ...
   // String number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story2seg8);
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this,R.raw.song_9);
    ...
    private void  openGameOption() {
        ...
        intent.putExtra("number",number);
        intent.putExtra("Game State", "Story2_seg8");
        startActivity(intent);
    }
