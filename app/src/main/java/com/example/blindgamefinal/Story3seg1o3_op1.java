...
public class Story3seg1o3_op1 extends AppCompatActivity {
    private Button b1;
    int maxid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story3seg1o3_op1);
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this, R.raw.song_l3s2o3_o1);
    ...
    private void openGameOption() {
        ...
        intent.putExtra("Game State", "Story3seg1o3_op1");
