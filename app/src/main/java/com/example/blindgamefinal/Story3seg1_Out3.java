...
public class Story3seg1_Out3 extends AppCompatActivity {
    private Button b1;
    int maxid;
...
FirebaseDatabase database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = database.getInstance().getReference("Score").child("L3").child("S2");
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this, R.raw.song_l3s2o3);
    ...
    private void openGameOption() {
        ...
        intent.putExtra("Game State", "Story3_seg1_out3");
    ...
    private void  openSeg2_2() {
        Intent intent = new Intent(this, Story3seg1o3_op2.class);
        intent.putExtra("number",number);
        startActivity(intent);
    }
