...
public class Story3l3op3 extends AppCompatActivity {
    private Button b1;
    int maxid;
    ...
    MediaPlayer player,player1,player2,player3,player4,player5,player6,player7,player8,player9,players,playerend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story3l3op3);
        ...
        if(playerend==null)
        {
            playerend = MediaPlayer.create(this, R.raw.song_endl);


        }
        if(player==null)
        {
            player = MediaPlayer.create(this, R.raw.song_l3s3o3);
    ...
    private void openGameOption() {
        ...
        intent.putExtra("Game State", "Story3l3op3");
