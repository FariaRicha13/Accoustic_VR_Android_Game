...
public class Story3seg1_Out2 extends AppCompatActivity {
    private Button b1;
    int maxid;
...
String number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story3_seg1);
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this, R.raw.song_l3s2o2);
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if((!textView.getText().toString().equals("fast forward"))&&(!textView.getText().toString().equals("fast backward"))&&(!textView.getText().toString().equals("quit"))&&(!textView.getText().toString().equals("next")) ) {
                            player2.start();
...
player.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
    ...
    private void openGameOption() {
        ...
        intent.putExtra("Game State", "Story3_seg1_out2");
        startActivity(intent);
    }


    private void  openNextSeg() {
