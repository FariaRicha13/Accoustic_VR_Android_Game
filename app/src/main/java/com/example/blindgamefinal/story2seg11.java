...
public class story2seg11 extends AppCompatActivity {
    private Button b1;
    int maxid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story2seg11);
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this,R.raw.song_11);
    ...
    private void  openGameOption() {
        ...
        intent.putExtra("number",number);
        intent.putExtra("Game State", "Story2_seg11");
        startActivity(intent);
    }
