...
public class story2seg13 extends AppCompatActivity {
    private Button b1;
    int maxid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story2seg13);
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this,R.raw.song_13);
    ...
    private void  openGameOption() {
        ...
        intent.putExtra("number",number);
        intent.putExtra("Game State", "Story2_seg13");
        startActivity(intent);
    }
