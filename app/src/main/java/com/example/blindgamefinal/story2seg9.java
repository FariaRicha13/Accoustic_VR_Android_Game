...
public class story2seg9 extends AppCompatActivity {
    private Button b1;
    int maxid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story2seg9);
        ...
        if(player==null)
        {
            player = MediaPlayer.create(this,R.raw.song_8);
    ...
    private void  openGameOption() {
        ...
        intent.putExtra("number",number);
        intent.putExtra("Game State", "Story2_seg9");
        startActivity(intent);
    }
